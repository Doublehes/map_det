...
config_default.model.map_det_head.aux_loss = True
config_default.model.map_det_head.num_decoder_layers = 3
config_default.model.map_det_head.one2many_num_aux_queries = 32
...
# ── 数据 ──
# config_default.data.batch_size = 2
...
config_default.pretrained = './work_dirs/stage1_seg_pretrain/latest.pth'
